export default function ButtonComponent({
  ...
  const styles = {
    ...
    yellow: () => 
      "focus:outline-none text-white bg-amber-700 hover:bg-amber-800 focus:ring-4 focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-amber-600 dark:hover:bg-amber-700 dark:focus:ring-amber-800",
    custom: function () {
