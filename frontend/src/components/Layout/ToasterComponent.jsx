...
export default function ToastrComponent() {
  ...
  const icons = {
    success: (
      <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200 animate-in slide-in-from-right-60">
        <svg
          aria-hidden="true"
          className="w-5 h-5"
          fill="currentColor"
  ...
  return (
    <div className="flex justify-end m-5 z-[100] h-[10%] w-[13%] right-0 absolute float-right">
      {toast ? (
        <div
          id="toast"
          className="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 z-[99]"
          role={"alert"}
        >
          {icons[toast.icon]}
